...
func (r *mutationResolver) UpdateCounters(ctx context.Context, input model.UpdateCountersInput) (*bool, error) {
	...
	err := db.UpdateCountersAndBalance(ctx, input.BotInstanceName, *input.WINCounter, *input.LOSSCounter, *input.TIMEOUTGainCounter, *input.TIMEOUTLossCounter, input.AccountBalance)
	if err != nil {
